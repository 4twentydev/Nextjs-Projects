...
export function HeroSection() {
  return (
    <div className="flex flex-col items-center gap-6 mt-5 relative">
      ...
      <div className="py-2">
        <h1 className={styles.text.title}>4twenty Projects</h1>
      </div>
      <p className={styles.text.subtitle}>A modern, type-safe Next.js starter template designed for AI-driven development @ 4twenty</p>
